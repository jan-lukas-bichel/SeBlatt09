...
public class Vorstellung {
	 ...
	 */
	public Vorstellung(Kinosaal kinosaal, Film film, Uhrzeit anfangszeit, Uhrzeit endzeit, Datum datum,
			Geldbetrag preis) {
		...
		assert preis.getCentbetrag() > 0 : "Vorbedingung verletzt: preis > 0";
	...
	/**
	 * Gibt den Verkaufspreis in Eurocent für Karten zu dieser Vorstellung zurück.
	 * 
	 */
	...
	/**
	 * Prüft, ob ein gegebener Platz verkauft werden kann. Dafür wird geschaut, ob
	 * der gegebene Platz bisher verkauft ist.
	 * 
	...
	/**
	 * Prüft, ob gegebene Plätze alle verkauft werden können. Dafür wird geschaut,
	 * ob keiner der gegebenen Plätze bisher verkauft ist.
	 * 
	...
	/**
	 * Prüft, ob ein gegebener Platz stornierbar ist. Dafür wird geschaut, ob ein
	 * gegebener Platz verkauft ist.
	 * 
