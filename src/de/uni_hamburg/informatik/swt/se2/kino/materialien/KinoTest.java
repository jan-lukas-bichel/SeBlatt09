...
public class KinoTest {
	...
	public void setUp() {
		...
		_vorstellungSaal1Film0 = new Vorstellung(_saal1, _film0, _u1, _u2, _d1, Geldbetrag.select(9, 0));
		_vorstellungSaal2Film1 = new Vorstellung(_saal2, _film1, _u1, _u2, _d1, Geldbetrag.select(10, 0));
		_vorstellungSaal2Film2a = new Vorstellung(_saal2, _film2, _u2, _u3, _d1, Geldbetrag.select(9, 0));
		_vorstellungSaal2Film2b = new Vorstellung(_saal2, _film2, _u3, _u4, _d1, Geldbetrag.select(9, 0));

		_alleVorstellungen = new Vorstellung[] { _vorstellungSaal1Film0, _vorstellungSaal2Film1,
	...
	public void testGibTagesplan() {
		...
		assertTrue(tagesplan.getVorstellungen().containsAll(Arrays.asList(_vorstellungSaal2Film1,
				_vorstellungSaal2Film2a, _vorstellungSaal2Film2b, _vorstellungSaal1Film0)));
	}
