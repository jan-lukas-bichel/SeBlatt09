...
class BarzahlungsWerkzeugUI {
	...
	/**
	 * Markiert das Gezahlt-Textfeld als ausreichend (grün) oder als nichtausrechend
	 * (rot)
	 * 
	 * @param ausreichend true, wenn es als ausreichend markiert werden soll, sonst
	 *                    false
	 */
	...
	/**
	 * Markiert das Restbetrag-Textfeld als Rückgeld-Feld (grün), wenn ausreichend
	 * gezahlt wurde, oder als "Noch zu zahlen"-Feld (rot)
	 * 
	 * @param ausreichend true, wenn es als fehlerhaft markiert werden soll, sonst
	 *                    false
	 */
	...
	/**
	 * Erstellt das Hauptpanel mit den drei Anzeigen für die Beträge und beschriftet
	 * diese sinnvoll.
	 * 
